---
title: "Building a typed struct macro"
date: "2021-04-16"
permalink: "/posts/2021/04/the_elixir_ast_typedstruct/"
image: "/assets/img/posts/a_deep_dive_into_the_elixir_ast_cover.png"
description: "Analyzing the AST to build a typed struct macro."
tags:
  - elixir
  - ast
  - macros
series: "A deep dive into the Elixir AST"
seriesSlug: "elixir-ast"
chapter: 2
---

<!-- excerpt -->

In the previous chapter we looked into the AST and learned what kind of shapes it can take, in this chapter we will leverage that knowledge to build a typed struct macro.
